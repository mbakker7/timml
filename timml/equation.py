...
class PotentialEquation(Equation):
    def equation(self):
...
class MscreenWellEquation(Equation):
    def equation(self):
...
class DisvecEquationOut(Equation):
    def equation(self):
...
class LeakyWallEquation(Equation):
    def equation(self):
...
class HeadDiffEquation(Equation):
    def equation(self):
...
class HeadDiffEquation2(Equation):
...
class DisvecDiffEquation(Equation):
    def equation(self):
        """Mix-in class that returns matrix rows for difference in head between inside and
        outside equals zeros
        Returns matrix part (nunknowns,neq)
...
class DisvecDiffEquation2(Equation):
    def equation(self):
        """Mix-in class that returns matrix rows for difference in head between inside and
        outside equals zeros
        Returns matrix part (nunknowns,neq)
...
class IntDisVecEquation(Equation):
    def equation(self):
        mat = np.empty((self.nunknowns, self.model.neq))
        rhs = np.zeros(self.nunknowns)  # Needs to be initialized to zero
        for icp in range(self.ncp):
