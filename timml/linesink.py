...
class LineSinkBase(LineSinkChangeTrace, Element):
    ...
    def potinf(self, x, y, aq=None):
        ...
        if aq == self.aq:
            pot = np.zeros(aq.naq)
            pot[:] = potbeslsho(float(x), float(y), self.z1, self.z2, aq.lab, 0,
                                             aq.ilap, aq.naq)
    ...
    def disvecinf(self, x, y, aq=None):
        ...
        if aq == self.aq:
            ...
            qxqy[:, :] = disbeslsho(float(x), float(y), self.z1, self.z2, aq.lab,
                                                 0, aq.ilap, aq.naq)
...
class LineSinkHoBase(LineSinkChangeTrace, Element):
    ...
    def potinf(self, x, y, aq=None):
        ...
        if aq == self.aq:
            ...
            pot[:, :] = potbeslsv(float(x), float(y), self.z1, self.z2, aq.lab,
    ...
    def disvecinf(self, x, y, aq=None):
        ...
        if aq == self.aq:
            ...
            qxqy[:, :] = disbeslsv(float(x), float(y), self.z1, self.z2, aq.lab,
                                                self.order, aq.ilap, aq.naq)
