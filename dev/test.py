...
ml = ModelMaq(kaq=[1, 2], z=[12, 10, 5, 4, 0], c=[20,20], top='semi', hstar=0.0)
xy = [(-5,0), (5,0), (5,8), (-5,8)]
p1 = PolygonInhomMaq(ml, xy=[(-5,0), (5,0), (5,8), (-5,8)], kaq=[0.2, 8], z=[11,10,5,4,0], c=[2, 20], top='semi', hstar=1.0, order=3, ndeg=3)
