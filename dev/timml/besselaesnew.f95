module besselaesnew
    ...
    real(kind=8), dimension(0:8) :: ac,bc
...
contains
    ...
    function disbeslsho(x,y,z1,z2,lambda,order,ilap,naq) result(rv)
        ...
        do i=ilap+1, naq
            ...
            if ( abs(z) < (Rconv + rONE/biglab) ) then
                wdis = IntegralG(zin,z1in,z2in,Lin,lambda(i),order,Rconv)
    ...
    function IntegralF(zin,z1in,z2in,Lin,lambda,order,Rconv) result (pot)
    ...
    function IntegralG(zin,z1in,z2in,Lin,lambda,order,Rconv) result(wdis)
...
program besseltest
    ...
    !real(kind=8), dimension(2) :: pot
    !real(kind=8), dimension(2,2) :: potv
    ...
    qxqy = disbeslsho(x,y,z1,z2,lab,0,ilap,naq)
    print *,qxqy(1,1:naq)
    print *,qxqy(2,1:naq)
    qxqy = disbeslsho(x,y,z1,z2,lab,1,ilap,naq)
    print *,qxqy(1,1:naq)
    print *,qxqy(2,1:naq)
    qxqyv = disbeslsv(x, y, z1, z2, lab, 1, ilap, naq)
    print *,qxqyv(1,1:naq)
