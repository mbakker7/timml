...
def potbesldho(x):
    pot = besselaesnew.potbesldho(2.0, 1.0, complex(-3.0, -1.0), complex(2.0, 2.0),
                                  [0.0, 2.0, 11.0], x, 1, 3)
    return pot
...
# @pytest.mark.skip(reason="no fortran extension by default")
def test_potbesldv():
    potv = besselaesnew.potbesldv(2.0, 1.0, complex(-3.0, -1.0), complex(2.0, 2.0),
                                  [0.0, 2.0, 11.0], 1, 1, 3)
...
# @pytest.mark.skip(reason="no fortran extension by default")
def test_disbesldho():
    qxqy_zero = besselaesnew.disbesldho(2.0, 1.0, complex(-3.0, -1.0), complex(2.0, 2.0),
                                        [0.0, 2.0, 11.0], 0, 1, 3)
    ...
    qxqy_one = besselaesnew.disbesldho(2.0, 1.0, complex(-3.0, -1.0), complex(2.0, 2.0),
                                       [0.0, 2.0, 11.0], 1, 1, 3)
...
# @pytest.mark.skip(reason="no fortran extension by default")
def test_disbesldv():
    qxqyv = besselaesnew.disbesldv(2.0, 1.0, complex(-3.0, -1.0), complex(2.0, 2.0),
                                   [0.0, 2.0, 11.0], 1, 1, 3)
